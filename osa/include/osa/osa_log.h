...
OSA_API int OSA_logInit(const OSA_LogOptions *pOptions, OSA_LogHandle *pHandle);

OSA_API int OSA_logDeinit(OSA_LogHandle handle);

OSA_API void OSA__logd(OSA_LogHandle handle, const Char *pModule, const Char *pFile, const Char *pFunc, const long line, const Char *fmt, ...);

OSA_API void OSA__logi(OSA_LogHandle handle, const Char *pModule, const Char *pFile, const Char *pFunc, const long line, const Char *fmt, ...);

OSA_API void OSA__logw(OSA_LogHandle handle, const Char *pModule, const Char *pFile, const Char *pFunc, const long line, const Char *fmt, ...);

OSA_API void OSA__loge(OSA_LogHandle handle, const Char *pModule, const Char *pFile, const Char *pFunc, const long line, const Char *fmt, ...);
