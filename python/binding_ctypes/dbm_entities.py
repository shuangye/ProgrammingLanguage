...
# Created by Papillon. Fri Oct 20 08:12:34 2017. 
...
class DBM_UserHouse(ctypes.Structure):
    _fields_ = [
        ...
        ("idcard"                  , ctypes.c_char    * 52   ),  # [08]
        ("arcode"                  , ctypes.c_char    * 64   ),  # [09]
        ("crk_uuid"                , ctypes.c_char    * 36   ),  # [10]
        ("crk_crkno"               , ctypes.c_char    * 52   ),  # [11]
